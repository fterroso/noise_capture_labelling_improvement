...
public class Storage extends SQLiteOpenHelper {
    ...
    public static final TagInfo[] TAGS_INFO = {
            t(0, "voice", R.id.tags_predominant_sound_sources_col1, R.color.tag_group_human),
            t(1, "walks", R.id.tags_predominant_sound_sources_col1, R.color.tag_group_human),
            t(2, "water", R.id.tags_predominant_sound_sources_col1, R.color.tag_group_human),
            t(3, "wind", R.id.tags_predominant_sound_sources_col1, R.color.tag_group_human),
            t(4, "animals", R.id.tags_predominant_sound_sources_col1, R.color.tag_group_human),
            t(5, "industry_noise", R.id.tags_predominant_sound_sources_col2, R.color.tag_group_traffic),
            t(6, "tram", R.id.tags_predominant_sound_sources_col2, R.color.tag_group_traffic),
            t(7, "explosion", R.id.tags_predominant_sound_sources_col2, R.color.tag_group_traffic),
            t(8, "subway", R.id.tags_predominant_sound_sources_col2, R.color.tag_group_traffic),
            t(9, "music", R.id.tags_predominant_sound_sources_col2, R.color.tag_group_traffic),
            t(10, "bicycle", R.id.tags_predominant_sound_sources_col3, R.color.tag_group_natural),
            t(11, "alarms", R.id.tags_predominant_sound_sources_col3, R.color.tag_group_natural),
            t(12, "firecrackers", R.id.tags_predominant_sound_sources_col3, R.color.tag_group_natural),
            t(13, "ship", R.id.tags_predominant_sound_sources_col3, R.color.tag_group_natural),
            t(14, "vegetables", R.id.tags_predominant_sound_sources_col3, R.color.tag_group_natural),
            t(15, "water", R.id.tags_predominant_sound_sources_col4, R.color.tag_group_work),
            t(16, "ship", R.id.tags_predominant_sound_sources_col4, R.color.tag_group_work),
            t(17, "train", R.id.tags_predominant_sound_sources_col4, R.color.tag_group_work),
            t(18, "helicopter", R.id.tags_predominant_sound_sources_col4, R.color.tag_group_work),
            t(19, "plane", R.id.tags_predominant_sound_sources_col4, R.color.tag_group_work)};
